...
contract Owned is Context {
    ...
    modifier onlyOwner {
        ...
        require(_msgSender() == _owner, "UnicToken: Only Owner can perform this task");
    ...
    function acceptOwnership() public {
        ...
        require(_msgSender() == _newOwner, "UnicToken: Token Contract Ownership has not been set for the address");
...
contract UnicToken is IBEP20, Owned {
